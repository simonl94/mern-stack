        ...
        <div className="form-group">
          <div className="form-check form-check-inline">
            <input
              ...
              id="person_positionIntern"
              value="Intern"
              checked={form.person_level === 'Intern'}
              onChange={(e) => updateForm({ person_level: e.target.value })}
            />
            <label htmlFor="person_positionIntern" className="form-check-label">
              Intern
            </label>
          </div>
          <div className="form-check form-check-inline">
            <input
              ...
              type="radio"
              name="positionOptions"
              id="person_positionJunior"
              value="Junior"
              checked={form.person_level === 'Junior'}
              onChange={(e) => updateForm({ person_level: e.target.value })}
            />
            <label htmlFor="person_positionJunior" className="form-check-label">
              Junior
            </label>
          </div>
          <div className="form-check form-check-inline">
            <input
              ...
              type="radio"
              name="positionOptions"
              id="person_positionSenior"
              value="Senior"
              checked={form.person_level === 'Senior'}
              onChange={(e) => updateForm({ person_level: e.target.value })}
            />
            <label htmlFor="person_positionSenior" className="form-check-label">
              Senior
            </label>
          </div>
        </div>
